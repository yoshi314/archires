...
ALTER TABLE `glpi_plugin_archires_display` ADD `display_ip` ENUM( '1', '0' ) NOT NULL DEFAULT '0';
ALTER TABLE `glpi_plugin_archires_display` ADD `system` ENUM( '1', '0' ) NOT NULL DEFAULT '0';
