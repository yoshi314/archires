...
if(!isset($_POST["id"])) {
	...
	if (empty($_POST["id"])){
		...
		switch($_POST['glpi_tab']){
			case -1 :
				plugin_archires_query_showTypes(PLUGIN_ARCHIRES_APPLIANCES_QUERY,$_POST["id"]);
				break;
			case 2 :
				plugin_archires_view_Associated(PLUGIN_ARCHIRES_APPLIANCES_QUERY,$_POST["id"]);
				plugin_archires_query_Test(PLUGIN_ARCHIRES_APPLIANCES_QUERY,$_POST["id"]);
				break;
			case 10 :
