...
if(plugin_archires_haveRight("archires","r") || haveRight("config","w")){
	...
	manageGetValuesInSearch(PLUGIN_ARCHIRES_APPLICATIFS_TYPE);
			
	searchForm(PLUGIN_ARCHIRES_APPLICATIFS_TYPE,$_GET);

	showList(PLUGIN_ARCHIRES_APPLICATIFS_TYPE,$_GET);
